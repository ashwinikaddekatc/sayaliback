...
//		oldProject.setModules(projectRequest.getModules());
		...
		oldProject.setFavCnt(projectRequest.getFavCnt());
		oldProject.setIs_fav(projectRequest.getIs_fav());
		oldProject.setIs_archived(projectRequest.getIs_archived());
		oldProject.setIs_aged(projectRequest.getIs_aged());
		oldProject.setStaredCnt(projectRequest.getStaredCnt());
		oldProject.setIs_stared(projectRequest.getIs_stared());
		oldProject.setWatchlistedCnt(projectRequest.getWatchlistedCnt());
		oldProject.setIs_watchlisted(projectRequest.getIs_watchlisted());
		oldProject.setFuturisticCnt(projectRequest.getFuturisticCnt());
		oldProject.setIs_futuristic(projectRequest.getIs_futuristic());
		oldProject.setPinnedCnt(projectRequest.getPinnedCnt());
		oldProject.setIs_pinned(projectRequest.getIs_pinned());
	...
	public boolean moveUploadedTechnologyToBaseProjectDir(Rn_Project_Setup project) {
		...
		//Boolean accessibility = project.getAccessibility();
