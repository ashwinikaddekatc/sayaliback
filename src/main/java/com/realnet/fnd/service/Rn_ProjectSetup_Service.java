...
public interface Rn_ProjectSetup_Service {
	...
	//Page<Rn_Project_Setup> getAllByUserId(int userId);	
	//public List<Rn_Project_Setup> getAllById(List<Rn_Project_Setup> ids);
	
	List<Rn_Project_Setup> getAllByUserId(Long created_by);
	
	//Rn_Project_Setup getByProjectName(String projectName);
