...
//	}
	...
	public Rn_Module_Setup updateById(int id, Rn_Module_Setup moduleRequest) {
		...
		oldModule.setIsreadmeFile(moduleRequest.getIsreadmeFile());
		oldModule.setIsDefaultRepo(moduleRequest.getIsDefaultRepo());
		oldModule.setIsMicroservice(moduleRequest.getIsMicroservice());
		oldModule.setTags(moduleRequest.getTags());
		oldModule.setParentRepo(moduleRequest.getParentRepo());
		oldModule.setIsPortalDeployment(moduleRequest.getIsPortalDeployment());
