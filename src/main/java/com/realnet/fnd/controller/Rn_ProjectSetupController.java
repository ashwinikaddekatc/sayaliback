...
//		newProject.setAccountId(accId);
		...
		newProject.setAccessibility(oldProject.getAccessibility());
		newProject.setCategory(oldProject.getCategory());
		newProject.setNamespace(oldProject.getNamespace());
...
//			newModule.setAccountId(accId);
			...
			newModule.setIsreadmeFile(oldModule.getIsreadmeFile());
			newModule.setTags(oldModule.getTags());
			newModule.setIsDefaultRepo(oldModule.getIsDefaultRepo());
			newModule.setIsMicroservice(oldModule.getIsMicroservice());
			newModule.setIsPortalDeployment(oldModule.getIsDefaultRepo());
...
//				newHeader.setAccountId(accId);
				...
				newHeader.setDescription(oldHeader.getDescription());
				newHeader.setSecuirityprofile(oldHeader.getSecuirityprofile());
