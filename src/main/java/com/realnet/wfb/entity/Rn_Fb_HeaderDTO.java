...
public class Rn_Fb_HeaderDTO {
	...
	private String secuirityprofile;
...
// ==============================
	...
	public String getSecuirityprofile() {
		return secuirityprofile;
	}

	public void setSecuirityprofile(String secuirityprofile) {
		this.secuirityprofile = secuirityprofile;
	}
	...
	public Rn_Fb_HeaderDTO(String techStack, String objectType, String subObjectType, String uiName, String formType,
			String tableName, String lineTableName, String multilineTableName, String formCode, String description,
			String secuirityprofile, String jspName, String controllerName, String serviceName, String serviceImplName,
			String daoName, String daoImplName, boolean build, boolean updated, String menuName, String headerName,
	...
	public String toString() {
		return "Rn_Fb_HeaderDTO [techStack=" + techStack + ", objectType=" + objectType + ", subObjectType="
				...
				+ formCode + ", description=" + description + ", secuirityprofile=" + secuirityprofile + ", jspName="
				+ jspName + ", controllerName=" + controllerName + ", serviceName=" + serviceName + ", serviceImplName="
				+ serviceImplName + ", daoName=" + daoName + ", daoImplName=" + daoImplName + ", build=" + build
				+ ", updated=" + updated + ", menuName=" + menuName + ", headerName=" + headerName
				+ ", convertedTableName=" + convertedTableName + ", rn_fb_lines=" + rn_fb_lines + ", module=" + module
				+ ", rn_cff_actionBuilder=" + rn_cff_actionBuilder + "]";
	}
