...
export class OrderService {
  ...
  getmyprojectcount(): Observable<any> {
    return this.apiRequest.get('workspace/secworkspaceuser/count_myproject');
}
getsharedprocount(): Observable<any> {
  return this.apiRequest.get('workspace/secworkspaceuser/count_sharedwithme');
}
getnotdetails():Observable<any>{
  return this.apiRequest.get(`notification/get_notification`)
}
}
