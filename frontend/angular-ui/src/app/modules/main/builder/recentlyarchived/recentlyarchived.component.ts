...
@Component({
  selector: 'app-recentlyarchived',
  templateUrl: './recentlyarchived.component.html',
  styleUrls: ['./recentlyarchived.component.scss']
})
export class RecentlyarchivedComponent implements OnInit {
