...
@Component({
  selector: 'app-allprojectcard2',
  templateUrl: './allprojectcard2.component.html',
  styleUrls: ['./allprojectcard2.component.scss']
})
export class Allprojectcard2Component implements OnInit {
  projectsetup;
  type="project";
