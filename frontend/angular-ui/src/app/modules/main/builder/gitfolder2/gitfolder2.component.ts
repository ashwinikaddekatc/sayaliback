...
console.log(this.date);
  ...
  onclick(user:Suregit){
    ...
    this.router.navigate(["../gitfolder1"], { relativeTo: this.route ,queryParams:{id:user.sha, name:user.path,olddfol:this.secondfol,oldfol: this.oldfolder,folder:this.foldername,mainfol:this.springfol,main2fol:this.mainfol,main3fol:this.main2fol,main4fol:this.main3fol}});
  }
