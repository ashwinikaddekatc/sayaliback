...
@Component({
  selector: 'app-datastoreall',
  templateUrl: './datastoreall.component.html',
  styleUrls: ['./datastoreall.component.scss']
})
export class DatastoreallComponent implements OnInit {
  loading = false;
  error;
  selected: any[] = [];
  rowSelected :any= {};
  ...
  godata(){
    this.router.navigate(["../../dataflow"], { relativeTo: this.route });
  }
  onExport() {
