...
@Component({
  selector: 'app-datasourceadd',
  templateUrl: './datasourceadd.component.html',
  styleUrls: ['./datasourceadd.component.scss']
})
export class DatasourceaddComponent implements OnInit {
  ...
  onSubmit(){
    ...
    this.dataservice.create2(this.entryForm.value,this.selectedFile).subscribe((data)=>{
      console.log(data);
      if(data.status===200){
