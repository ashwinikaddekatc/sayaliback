...
import { animate, baseStyles, createId, CdsBaseFocusTrap, event, FocusTrapTracker, internalProperty, onKey, property, AnimationModalEnterName, reverseAnimation, } from '@cds/core/internal';
...
let CdsInternalOverlay = class CdsInternalOverlay extends CdsBaseFocusTrap {
    ...
    updated(props) {
        ...
        const newLayered = isNestedOverlay(this.focusTrapId, this.overlayIdPrefix, FocusTrapTracker.getTrapIds(), oldLayered);
