...
public class Rn_Bcf_Extractor_ServiceImpl implements Rn_Bcf_Extractor_Service {
	...
	public Rn_Bcf_Extractor updateById(int id, Rn_Bcf_Extractor extractorRequest) {
		...
		old_extractor.setService(extractorRequest.getService());
		// line part
...
//		System.out.println("AFTER REMOVING .ZIP = " + sampleFileName);
		...
		// List<Rn_Bcf_Extractor_Params> params = new
		// ArrayList<Rn_Bcf_Extractor_Params>();
		// GET FILE PATHS
...
//			}
			...
			rn_bcf_extractor_params.setFile_name_var(name);
			rn_bcf_extractor_params.setFile_name_dynamic_string(name);
			rn_bcf_extractor_params.setTotal_project_path_dynamic_string(ref_address_string);
...
//			this.updateById(headerId, rn_bcf_extractor); // need to test
	...
	public void moveFiles(int id, String toDir) throws IOException {
		...
		// List<Rn_Bcf_Extractor_Params> params_t =
		// getById(id).getRn_bcf_extractor_Params();
		// Rn_Bcf_Extractor extractor = this.getById(id);
		// log.debug("extractor : {} ",extractor);
		// List<Rn_Bcf_Extractor_Params> params_t =
		// extractor.getRn_bcf_extractor_Params();
