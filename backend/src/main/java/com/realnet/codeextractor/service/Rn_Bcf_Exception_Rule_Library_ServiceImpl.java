...
public class Rn_Bcf_Exception_Rule_Library_ServiceImpl implements Rn_Bcf_Exception_Rule_Library_Service {
	...
	public Rn_Bcf_Exception_Rules updateById(int id, Rn_Bcf_Exception_Rules ruleRequest) {
		...
		old_extractor.setEndstring(ruleRequest.getEndstring());
		old_extractor.setFile_name(ruleRequest.getFile_name());
		old_extractor.setKeyword(ruleRequest.getKeyword());
		old_extractor.setLinestring(ruleRequest.getLinestring());
		old_extractor.setPath(ruleRequest.getPath());
		old_extractor.setReplaceWith(ruleRequest.getReplaceWith());
		old_extractor.setStartstring(ruleRequest.getStartstring());
		old_extractor.setType(ruleRequest.getType());
		old_extractor.setService(ruleRequest.getService());
