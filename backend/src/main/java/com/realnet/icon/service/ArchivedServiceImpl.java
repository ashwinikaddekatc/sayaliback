...
//				.orElseThrow(() -> new ResourceNotFoundException(Constant.NOT_FOUND_EXCEPTION + " :" + id));
		archRepo.delete(archivedEntity);
		return true;
	}
	...
	@Override
    public List<ArchivedEntity> getAllByUserId(Long created_by) {
        // TODO Auto-generated method stub
        List<ArchivedEntity> bcf_extractor = archRepo.findByCreatedBy(created_by);
